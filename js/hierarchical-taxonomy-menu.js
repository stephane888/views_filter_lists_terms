...
(function ($, Drupal, drupalSettings) {
  ...
  $(document).ready(function () {
      ...
      if (self.find("a.active").length) {
        ...
        if (drupalSettings.interactiveParentMenu) {
          if (!self.hasClass("menu-item--active")) {
            self.children("i").toggleClass("arrow-right icon-minus");
          }
        }
      }
    });
    ...
    if (drupalSettings.interactiveParentMenu === false) {
      $(".hierarchical-taxonomy-menu .menu-item--expanded > a").on(
        "click",
        function (e) {
          e.preventDefault();
          let isChildVisible = $(this)
            .parent()
            .children(".menu")
            .is(":visible");
          if (isChildVisible) {
      ...
      $(".hierarchical-taxonomy-menu .menu-item--expanded > .parent-toggle").on(
        "click",
        function (e) {
          e.preventDefault();
          $(this).closest("i").toggleClass("arrow-right icon-minus");
          let isChildVisible = $(this)
            .parent()
            .children(".menu")
            .is(":visible");
